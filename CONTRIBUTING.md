...
- **Conventional Commits** — please use [Conventional Commits](https://www.conventionalcommits.org) for commit messages. A `commit-msg` hook is included to enforce this; activate it once with `git config core.hooksPath .githooks`.
